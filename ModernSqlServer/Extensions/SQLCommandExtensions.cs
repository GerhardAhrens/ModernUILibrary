...
namespace Microsoft.Data.SqlClient
{
    ...
    public static class SQLCommandExtensions
    {
        ...
        public static int CmdExecuteNonQuery(this SqlConnection @this, string sql, CommandType commandType = CommandType.Text)
        {
            int resultCommand = -1;
        ...
        public static int CmdExecuteNonQuery(this SqlConnection @this, SqlTransaction transaction, string sql, CommandType commandType = CommandType.Text)
        {
            int resultCommand = -1;
        ...
        public static int CmdExecuteNonQuery(this SqlConnection @this,
                                             string sql,
        ...
        public static T CmdExecuteScalar<T>(this SqlConnection connection, string sql, CommandType commandType = CommandType.Text)
        {
            if (connection == null)
            {
        ...
        public static T CmdExecuteScalar<T>(this SqlConnection connection,
                                            string sql,
                                            Dictionary<string, object> parameterCollection,
                                            CommandType commandType = CommandType.Text)
        {
        ...
        public static DataTable CmdReaderToDataTable(this SqlConnection connection, string sql, CommandType commandType = CommandType.Text)
        {
        ...
        public static DataTable CmdReaderToDataTable(this SqlConnection connection,
                                string sql,
                                Dictionary<string, object> parameterCollection,
                                CommandType commandType = CommandType.Text)
        {
        ...
        public static IEnumerable<TModel> CmdReaderToMap<TModel>(this SqlConnection connection, string sql, CommandType commandType = CommandType.Text)
        {
        ...
        public static string ConvertSqlToString(this SqlCommand pSqlCommand)
        {
            return string.Empty;
        }
