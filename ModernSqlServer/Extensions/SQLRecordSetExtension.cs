...
namespace Microsoft.Data.SqlClient
{
    ...
    public static class SQLRecordSetExtension
    {
        ...
        public static RecordSetResult<T> RecordSet<T>(this SqlConnection @this, string sql)
        {
            return new RecordSetResult<T>(@this, default, sql);
        }

        public static RecordSetResult<T> RecordSet<T>(this SqlConnection @this, string sql, SqlTransaction transaction)
        {
            return new RecordSetResult<T>(@this, default, sql, transaction);
        }
        ...
        /// <returns>Erwarteterer Wert der SQL Anweisung, werden keine Daten gefunden, wird entweder null oder der Default-Wert des Datentyp zurückgegeben.</returns>
        public static RecordSetResult<T> RecordSet<T>(this SqlConnection @this, string sql, Dictionary<string, object> parameterCollection)
        {
            return new RecordSetResult<T>(@this, default, sql, parameterCollection);
        }

        public static RecordSetResult<T> RecordSet<T>(this SqlConnection @this, string sql, Dictionary<string, object> parameterCollection, SqlTransaction transaction)
        {
            return new RecordSetResult<T>(@this, default, sql, parameterCollection, transaction);
        }
        ...
        /// <returns>Erwarteterer Wert der SQL Anweisung, werden keine Daten gefunden, wird entweder null oder der Default-Wert des Datentyp zurückgegeben.</returns>
        public static RecordSetResult<T> RecordSet<T>(this SqlConnection @this, string sql, SqlParameter[] parameterCollection)
        {
            return new RecordSetResult<T>(@this, default, sql, parameterCollection);
        }

        public static RecordSetResult<T> RecordSet<T>(this SqlConnection @this, string sql, SqlParameter[] parameterCollection, SqlTransaction transaction)
        {
            return new RecordSetResult<T>(@this, default, sql, parameterCollection, transaction);
        }
        ...
        private static T SetExecuteNonQuery<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            object getAs = null;
        ...
        private static T GetScalar<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            object getAs = null;
        ...
        private static T GetDataRow<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            object result = null;
        ...
        private static T GetCollectionView<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
        ...
        private static T GetDataTable<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            object result = null;
        ...
        private static T GetListOfTGeneric<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            T result = default;
        ...
        private static T GetListOfTNonGeneric<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
        ...
        private static T GetDictionary<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            T result = default;
        ...
        public static RecordSetResult<T> New<T>(this RecordSetResult<T> @this)
        {
            ...
            try
            {
                ...
                {
                    string sql = $"SELECT TOP 1 {@this.SQL}.* FROM {@this.SQL}";
        ...
        private static T NewDataRow<T>(SqlConnection connection, string sql)
        {
            object result = null;
        ...
        private static T ExecuteNonQuery<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter, SqlTransaction transaction)
        {
            object getAs = null;
        ...
        private static T ExecuteNonQuery<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlParameter[] sqliteParameter)
        {
            object getAs = null;
        ...
        private static T ExecuteNonQuery<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection, SqlTransaction transaction)
        {
            object getAs = null;
        ...
        private static T ExecuteNonQuery<T>(SqlConnection connection, string sql, Dictionary<string, object> parameterCollection)
        {
            object getAs = null;
    ...
    public class RecordSetResult<T>
    {
        ...
        /// <param name="sql">SQL Anweisung</param>
        public RecordSetResult(SqlConnection connection, T resultValue, string sql)
        {
        ...
        public RecordSetResult(SqlConnection connection, T resultValue, string sql, SqlTransaction transaction)
        {
            this.Connection = connection;
            this.SQL = sql;
        ...
        /// <param name="sql">SQL Anweisung</param>
        /// <param name="parameterCollection">Dictionary mit einer Liste von Parametern als String (Parametername) und Object (Parametervalue)</param>
        public RecordSetResult(SqlConnection connection, T resultValue, string sql, Dictionary<string, object> parameterCollection)
        {
            this.Connection = connection;
            this.SQL = sql;
            this.Transaction = null;
        ...
        public RecordSetResult(SqlConnection connection, T resultValue, string sql, Dictionary<string, object> parameterCollection, SqlTransaction transaction)
        {
            this.Connection = connection;
            this.SQL = sql;
            this.Result = resultValue;
        ...
        /// <param name="sql">SQL Anweisung</param>
        /// <param name="parameterCollection">SQLiteParameter Array mit einer Liste von Parametern als String (Parametername) und Object (Parametervalue)</param>
        public RecordSetResult(SqlConnection connection, T resultValue, string sql, SqlParameter[] parameterCollection)
        {
            this.Connection = connection;
            this.SQL = sql;
        ...
        public RecordSetResult(SqlConnection connection, T resultValue, string sql, SqlParameter[] parameterCollection, SqlTransaction transaction)
        {
            this.Connection = connection;
            this.SQL = sql;
            this.SQLiteParameter = parameterCollection;
        ...
        /// </summary>
        public SqlParameter[] SQLiteParameter { get; private set; }
