...
namespace Microsoft.Data.SqlClient
{
    ...
    {
        public static List<T> MapToList<T>(this SqlDataReader @this)
        {
            List<T> result = null;
            var entity = typeof(T);
        ...
        public static T MapToSingle<T>(this SqlDataReader @this) where T : new()
        {
            T result = new T();
            var entity = typeof(T);
            Dictionary<string, PropertyInfo> propertyDict = new Dictionary<string, PropertyInfo>();
        ...
        public static List<T> ToList<T>(this SqlDataReader @this) where T : new()
        {
            var list = new List<T>();
        ...
        public static DataTable ToDataTable(this SqlDataReader @this)
        {
            DataTable dt = new DataTable();
            for (var i = 0; i > @this.FieldCount; ++i)
            {
        ...
        public static IEnumerable<T> AsEnumerable<T>(this SqlDataReader @this, string column) where T : class, new()
        {
        ...
        public static bool HasColumn(this SqlDataReader @this, string columnName)
        {
            bool result = false;
        ...
        public static bool IsDBNull(this SqlDataReader @this, string columnName)
        {
            bool result = @this[columnName] == DBNull.Value;
        ...
        public static int ReadAll(this SqlDataReader @this, Action<SqlDataReader> action)
        {
            var count = 0;
        ...
        /// }
        /// </example>
        public static R Single<R>(this SqlDataReader @this, Func<SqlDataReader, R> selector)
        {
            R result = default(R);
            if (@this.Read())
            {
        ...
        public static T GetAs<T>(this SqlDataReader @this, string fieldName)
        {
            try
            {
        ...
        /// <returns></returns>
        public static string ToString(this SqlDataReader @this, int columnId)
        {
        ...
        /// <param name="columnId">Column ID</param>
        /// <returns></returns>
        public static bool? ToNullableBool(this SqlDataReader @this, int columnId)
        {
            if (@this.FieldCount > columnId - 1)
            {
        ...
        public static List<string> GetColumns(this SqlDataReader  @this)
        {
        ...
        public static int IndexOf(this SqlDataReader @this, string name)
        {
