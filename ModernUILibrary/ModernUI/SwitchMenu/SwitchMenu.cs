namespace ModernIU.Controls
{
    ...
    public class SwitchMenu : Selector
    {
        ...
        #region Orientation
        [Bindable(true), Category("Appearance"), Description("Orientation")]
        ...
        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(SwitchMenu), new PropertyMetadata(Orientation.Horizontal));
        #endregion
