namespace ModernIU.Controls
{
    ...
    public class SyntaxConfig : List<ISyntaxRule> , ISyntaxDriver
    {
        ...
        public DriverOperation Abilities => this.Select((rule) => rule.Op) ?.Aggregate(DriverOperation.None, (a, b) => a | b) ?? DriverOperation.None;
        ...
        public IEnumerable<FormatInstruction> Match(DriverOperation Operation, string Text)
        {
            ...
            List<FormatInstruction> matches = rules.SelectMany((rule) => rule.Match(Text)).ToList();
