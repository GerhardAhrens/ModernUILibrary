namespace ModernIU.Controls
{
    ...
    public class MCalendarItem : Control
    {
        ...
        private MCalendarDayButton[,] CalendarDayButtons = new MCalendarDayButton[7, 7];
        private MCalendarButton[,] CalendarButtons = new MCalendarButton[3, 4];
        ...
        static MCalendarItem()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(MCalendarItem), new FrameworkPropertyMetadata(typeof(MCalendarItem)));
        }
        ...
        private void InitMonthGrid()
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                MCalendarDayButton calendarDayButton = new MCalendarDayButton();
        ...
        private void InitYearGrid()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    MCalendarButton calendarButton = new MCalendarButton();
                    calendarButton.SetValue(Grid.RowProperty, i);
                    calendarButton.SetValue(Grid.ColumnProperty, j);
                    calendarButton.SetValue(MCalendarButton.HasSelectedDatesProperty, false);
        ...
        {
            MCalendarDayButton calendarDayButton = sender as MCalendarDayButton;
        ...
        {
            MCalendarButton calendarButton = sender as MCalendarButton;
        ...
        private void SetMonthModeHeaderButton()
        {
            if(this.PART_HeaderButton != null)
            {
                this.PART_HeaderButton.Content = this.DisplayDate.ToString("dd.MM.yyyy");
            }
        }
        ...
        {
            string[] dayOfWeeks = new string[] { "So", "Mo", "Di", "Mi", "Do", "Fr", "Sa" };
        ...
        public void SetSelectedDatesHighlight(ObservableCollection<DateTime> selectedDates)
        {
            ...
            {
                MCalendarDayButton dayButton = item as MCalendarDayButton;
        ...
        private void SetYearButtons()
        {
            ...
            foreach (object item in this.PART_YearView.Children)
            {
                ...
                MCalendarButton calendarButton = item as MCalendarButton;
