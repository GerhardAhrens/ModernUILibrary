...
namespace ModernIU.Controls.Chart
{
    ...
    public class TreeMapItem : HeaderedItemsControl
    {
        ...
        public static DependencyProperty TreeMapModeProperty
          = DependencyProperty.Register("TreeMapMode", typeof(TreeMapAlgo), typeof(TreeMapItem), new FrameworkPropertyMetadata(TreeMapAlgo.TreeMap, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsArrange));
