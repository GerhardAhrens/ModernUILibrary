...
namespace ModernIU.Base
{
    ...
    public class UIButtonCommand : ICommand
    {
        /// <summary>
        ...
        public UIButtonCommand(Action<object> execute) : this(execute, null)
        {
        }
        ...
        public UIButtonCommand(Action<object> execute, Predicate<object> canExecute)
        {
            if (execute == null)
            {
        ...
        public UIButtonCommand(Action<object> execute, Predicate<object> canExecute, Action preAction, Action postAction)
        {
            if (execute == null)
            {
                this.executeDelegate = new Action<object>(p1 => { });
