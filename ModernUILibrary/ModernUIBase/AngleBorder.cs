namespace ModernIU.Base
{
    ...
    public class AngleBorder : Decorator
    {
        ...
        private Geometry CreateGeometryTailAtTop()
        {
            ...
            RectangleGeometry g2 = new RectangleGeometry(new Rect(0, this.TailHeight, this.ActualWidth, this.ActualHeight - this.TailHeight), CornerRadius.TopLeft, CornerRadius.BottomRight);
