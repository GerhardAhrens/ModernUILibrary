//-----------------------------------------------------------------------
// <copyright file="UIButtonTCommand.cs" company="Lifeprojects.de">
//     Class: UIButtonTCommand
...
namespace ModernIU.Base
{
    ...
    public class UIButtonTCommand<TArgs> : ICommand
    {
        /// <summary>
        ...
        public UIButtonTCommand(Action<TArgs> execute) : this(execute, null)
        {
        }
        ...
        public UIButtonTCommand(Action<TArgs> execute, Predicate<TArgs> canExecute)
        {
            if (execute == null)
            {
        ...
        public UIButtonTCommand(Action<TArgs> execute, Predicate<TArgs> canExecute, Action preAction, Action postAction)
        {
            if (execute == null)
            {
                this.executeDelegate = new Action<TArgs>(p1 => { });
