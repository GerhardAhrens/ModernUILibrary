//-----------------------------------------------------------------------
// <copyright file="ImageBehavior.cs" company="Lifeprojects.de">
//     Class: ImageBehavior
...
// <date>15.08.2019</date>
//
// <summary>Class for UI Image for GIF Animation</summary>
//-----------------------------------------------------------------------
...
namespace ModernIU.Behaviors
{
    ...
    public static class ImageGifBehavior
    {
        public static readonly DependencyProperty AnimatedSourceProperty =
            DependencyProperty.RegisterAttached("AnimatedSource", typeof(ImageSource), typeof(ImageGifBehavior), new UIPropertyMetadata(null, AnimatedSourceChanged));
