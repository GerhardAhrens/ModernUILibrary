namespace ModernUIDemo
{
    ...
    /// <summary>
    /// Interaktionslogik für InputIntegerYesNo.xaml
    /// </summary>
    public partial class InputIntegerYesNo : UserControl, INotificationServiceMessage
    {
        private static readonly Regex regexIntPattern = new Regex("[^0-9.-]+");

        public InputIntegerYesNo()
        {
        ...
        protected override void OnPreviewKeyDown(KeyEventArgs e)
        {
            if (e.Key == Key.OemMinus || e.Key == Key.Subtract)
            {
                ...
                {
                    InputIntegerYesNo ctrl = (InputIntegerYesNo)e.Source;
