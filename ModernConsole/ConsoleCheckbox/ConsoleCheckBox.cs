namespace System
{
    ...
    public class ConsoleCheckbox
    {
        ...
        public void Show()
        {
            ...
            System.Console.WriteLine("(Verwenden Sie die Pfeiltasten für nach oben und unten, die Leertaste zum Markieren und die Eingabetaste zur Auswahl.)");
            ...
            if (_error) System.Console.WriteLine("\nMindestens ein Element muss ausgewählt werden!");
        }
