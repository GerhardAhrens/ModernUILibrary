/*
 * <copyright file="ConsoleHelper.cs" company="Lifeprojects.de">
 *     Class: ConsoleHelper
    ...
    public static class ConsoleHelper
    {
        ...
        private static void WriteProgress(ConsoleColor graphColor = ConsoleColor.DarkGreen)
        {
            ...
            if (progressTotal > 0)
            {
                ...
                ConsoleHelper.Write($"{ProgressTitle} {value.ToString().PadLeft(progressTotal.ToString().Length)}/{progressTotal} ", ProgressTitleColor);
