/*
 * <copyright file="CmdManager.cs" company="Lifeprojects.de">
 *     Class: CmdManager
    ...
    public class CmdManager
    {
        ...
        public static string[] CommandLineToArgs(string commandLine)
        {
            ...
            return Split(commandLine, (c) => {
                ...
                return !inQuotes && c == ' ';}).Select(arg => TrimMatchingQuotes(arg.Trim(), '\"')).Where(arg => !string.IsNullOrEmpty(arg)).ToArray();
        }
    }
}
