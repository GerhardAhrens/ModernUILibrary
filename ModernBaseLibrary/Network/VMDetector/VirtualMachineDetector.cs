namespace ModernBaseLibrary.Network
{
    ...
    public class VirtualMachineDetector
    {
        ...
        static BIOS _bios;
        static PhysicalMemory _physicalMemory;
        ...
        static VirtualMachineDetector()
        {
            _detectors = new IVirtualEnvironment[]
           {
            ...
            _physicalMemory = Create<PhysicalMemory>("Win32_PhysicalMemory");
            ...
            */
            ...
            Console.WriteLine("PhysicalMemory INFO");
            Console.WriteLine("=============");
            Console.WriteLine(_physicalMemory);
            Console.WriteLine();
