...
//
// <summary>
// Die Klasse stellt Informationen zu einem Typ zur Verfügung
// Die als internal deklariter Klasse wird von DeepConvertSettings und DeepConvert verwendet
// </summary>
//
// <Remark>
...
namespace ModernBaseLibrary.Core
{
    ...
    public class ConvertTypeInfo
    {
        ...
        {
            assemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName() { Name = Guid.NewGuid().ToString() }, AssemblyBuilderAccess.Run);
