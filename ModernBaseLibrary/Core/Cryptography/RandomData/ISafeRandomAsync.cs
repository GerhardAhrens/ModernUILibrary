//-----------------------------------------------------------------------
// <copyright file="ISafeRandomAsync.cs" company="Lifeprojects.de">
//     Class: ISafeRandomAsync
...
//
// <summary>
// The Interface Class for create random Data (SafeRandomAsync)
// </summary>
//-----------------------------------------------------------------------
...
namespace ModernBaseLibrary.Cryptography
{
    ...
    /// </summary>
    public interface ISafeRandomAsync
    {
        /// <summary>
