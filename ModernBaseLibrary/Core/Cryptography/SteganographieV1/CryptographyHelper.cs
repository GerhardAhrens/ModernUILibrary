namespace ModernBaseLibrary.Cryptography
{
    ...
    internal static class CryptographyHelper
    {
        ...
        {
            //For Mixed Colors
            int rnd1 = ImagePassword.Random.Next(0, b);
            int rnd2 = ImagePassword.Random.Next(0, b);
            ...
            switch (colorScheme)
            {
                ...
                case ColorScheme.Rainbow:
                    int rainbow1 = ImagePassword.Random.Next(0, 255);
                    int rainbow2 = ImagePassword.Random.Next(0, 255);
        ...
        internal static Color[] GetPixelsFromImage(int width, int y, DrawingScheme drawingScheme, ColorScheme colorScheme, Image encryptedImage)
        {
