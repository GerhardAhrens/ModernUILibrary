//-----------------------------------------------------------------------
// <copyright file="GuidGenerator.cs" company="Lifeprojects.de"">
//     Class: GuidGenerator
...
namespace ModernBaseLibrary.Core
{
    ...
    public static class GuidGenerator
    {
        ...
        public static Guid GenerateTimeBasedGuid(DateTimeOffset dateTime, byte[] clockSequence, byte[] node)
        {
            ...
            // copy node
            Array.Copy(node, 0, guid, NodeByte, System.Math.Min(6, node.Length));

            // copy clock sequence
            Array.Copy(clockSequence, 0, guid, GuidClockSequenceByte, System.Math.Min(2, clockSequence.Length));

            // copy timestamp
            Array.Copy(timestamp, 0, guid, TimestampByte, System.Math.Min(8, timestamp.Length));
