//-----------------------------------------------------------------------
// <copyright file="ISO3166Country.cs" company="Lifeprojects.de">
...
// <date>12.05.2023 15:18:07</date>
//
// <summary>
// Die Klasse gibt eine Liste von ISO3166 Ländern zurück
// </summary>
//-----------------------------------------------------------------------
...
namespace ModernBaseLibrary.Core
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ISO3166Country"/> class.
        /// </summary>
        public ISO3166Country(string name, string twoLetterCode, string threeLetterCode, string numericCode)
        {
            this.Name = name;
        ...
        public static readonly ISO3166Country[] List = new[]
                {
            new ISO3166Country("Afghanistan", "AF", "AFG", "004"),
            new ISO3166Country("Albania", "AL", "ALB", "008"),
            new ISO3166Country("Algeria", "DZ", "DZA", "012"),
            new ISO3166Country("American Samoa", "AS", "ASM", "016"),
            new ISO3166Country("Andorra", "AD", "AND", "020"),
            new ISO3166Country("Angola", "AO", "AGO", "024"),
            new ISO3166Country("Anguilla", "AI", "AIA", "660"),
            new ISO3166Country("Antarctica", "AQ", "ATA", "010"),
            new ISO3166Country("Antigua and Barbuda", "AG", "ATG", "028"),
            new ISO3166Country("Argentina", "AR", "ARG", "032"),
            new ISO3166Country("Armenia", "AM", "ARM", "051"),
            new ISO3166Country("Aruba", "AW", "ABW", "533"),
            new ISO3166Country("Australia", "AU", "AUS", "036"),
            new ISO3166Country("Austria", "AT", "AUT", "040"),
            new ISO3166Country("Azerbaijan", "AZ", "AZE", "031"),
            new ISO3166Country("Bahamas", "BS", "BHS", "044"),
            new ISO3166Country("Bahrain", "BH", "BHR", "048"),
            new ISO3166Country("Bangladesh", "BD", "BGD", "050"),
            new ISO3166Country("Barbados", "BB", "BRB", "052"),
            new ISO3166Country("Belarus", "BY", "BLR", "112"),
            new ISO3166Country("Belgium", "BE", "BEL", "056"),
            new ISO3166Country("Belize", "BZ", "BLZ", "084"),
            new ISO3166Country("Benin", "BJ", "BEN", "204"),
            new ISO3166Country("Bermuda", "BM", "BMU", "060"),
            new ISO3166Country("Bhutan", "BT", "BTN", "064"),
            new ISO3166Country("Bolivia, Plurinational State of", "BO", "BOL", "068"),
            new ISO3166Country("Bonaire, Sint Eustatius and Saba", "BQ", "BES", "535"),
            new ISO3166Country("Bosnia and Herzegovina", "BA", "BIH", "070"),
            new ISO3166Country("Botswana", "BW", "BWA", "072"),
            new ISO3166Country("Bouvet Island", "BV", "BVT", "074"),
            new ISO3166Country("Brazil", "BR", "BRA", "076"),
            new ISO3166Country("British Indian Ocean Territory", "IO", "IOT", "086"),
            new ISO3166Country("Brunei Darussalam", "BN", "BRN", "096"),
            ...
            new ISO3166Country("Congo, the Democratic Republic of the", "CD", "COD", "180"),
            ...
            new ISO3166Country("Czechia", "CZ", "CZE", "203"),
            ...
            new ISO3166Country("Eswatini", "SZ", "SWZ", "748"),
            ...
            new ISO3166Country("North Macedonia", "MK", "MKD", "807"),
            ...
            new ISO3166Country("Solomon Islands", "SB", "SLB", "090"),
            ...
            new ISO3166Country("Taiwan, Province of China", "TW", "TWN", "158"),
            ...
            new ISO3166Country("Virgin Islands, British", "VG", "VGB", "092"),
        ...
        public Dictionary<string, string> ToDictionary
        {
            get
            { 
                return List.OrderBy(x => x.Name).ToDictionary(x => x.TwoLetterCode, x => x.Name); 
            }
        }
    }
}
