...
namespace ModernBaseLibrary.Collection
{
    ...
    public class ConcurrentHashSet<T> : ICollection<T>, IReadOnlyCollection<T>, ICollection
    {
        ...
        /// </summary>
        public ConcurrentHashSet() : this(PlatformCPUHelper.DefaultConcurrencyLevel, DEFAULT_CAPACITY, true, EqualityComparer<T>.Default)
        {
        }
        ...
        public ConcurrentHashSet(IEqualityComparer<T> comparer) : this(PlatformCPUHelper.DefaultConcurrencyLevel, DEFAULT_CAPACITY, true, comparer)
        {
        }
