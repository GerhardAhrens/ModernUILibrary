namespace ModernBaseLibrary.Collection
{
    ...
    public class MinHeap<T> : BaseHeapMinMax<T> where T : IComparable<T>
    {
        public MinHeap() : base(HeapType.Min)
        {
        }
    }
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class MaxHeap<T> : BaseHeapMinMax<T> where T : IComparable<T>
    {
        public MaxHeap() : base(HeapType.Max)
        {
        }
    }
    ...
    public abstract class BaseHeapMinMax<T> where T : IComparable<T>
    {
        ...
        protected BaseHeapMinMax(HeapType heapType)
        {
            _heapType = heapType;
            Clear();
        }
