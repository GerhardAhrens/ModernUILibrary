//-----------------------------------------------------------------------
// <copyright file="ReadOnlyDictionaryEx.cs" company="Lifeprojects.de">
//     Class: ReadOnlyDictionaryEx
...
//
// <summary>Definition of ReadOnlyDictionaryEx Class</summary>
//-----------------------------------------------------------------------
...
namespace ModernBaseLibrary.Collection
{
    ...
    /// </summary>
    public sealed class ReadOnlyDictionaryEx<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public ReadOnlyDictionaryEx(IEnumerable<KeyValuePair<TKey, TValue>> source) : this(source, null)
        {
        }
        ...
        public ReadOnlyDictionaryEx(IEnumerable<KeyValuePair<TKey, TValue>> source, IEqualityComparer<TKey> comparer)
        {
        ...
        /// </summary>
        /// <param name="source"></param>
        public ReadOnlyDictionaryEx(Dictionary<TKey, TValue> source)
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
        ...
        /// <summary>
        /// Determines whether the <see cref="ReadOnlyDictionaryEx{TKey,TValue}"/> contains the specified key.
        /// </summary>
        /// <param name="key">The key to locate in the <see cref="ReadOnlyDictionaryEx{TKey,TValue}"/>.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets a collection containing the keys in the <see cref="ReadOnlyDictionaryEx{TKey,TValue}"/>.
        /// </summary>
