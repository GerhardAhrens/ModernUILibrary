namespace ModernBaseLibrary.Core
{
    ...
    public static partial class Argument
    {
            ...
            where TParam : IComparable<TParam>
        {
            ...
            Argument.NotLessThanOrEqualTo(param, threshold, argumentOutOfRangeException);
        }
            ...
            where TException : Exception, new()
        {
            ...
            Argument.NotLessThanOrEqualTo<TParam, TException>(param, threshold, message);
        }
            ...
            where TException : Exception, new()
        {
            ...
            Argument.NotLessThanOrEqualTo(param, threshold, exception);
        }
