...
namespace ModernBaseLibrary.ExcelWriter
{
    ...
    public class StyleManager
    {
        ...
        public Style.Border GetBorderByHash(int hash)
        {
            ...
            if (component == null)
            {
                throw new ExcelStyleException("MissingReferenceException", "The style component with the hash '" + hash + "' was not found");
            }
        ...
        public Style GetStyleByName(string name)
        {
            ...
            throw new ExcelStyleException("MissingReferenceException", "The style with the name '" + name + "' was not found");
        }
        ...
        public void RemoveStyle(string styleName)
        {
            ...
            if (!match)
            {
                throw new ExcelStyleException("MissingReferenceException", "The style with the name '" + styleName + "' was not found in the style manager");
            }
        ...
        internal static StyleManager GetManagedStyles(ExcelWriter workbook)
        {
