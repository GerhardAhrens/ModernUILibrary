...
namespace ModernBaseLibrary.ExcelWriter
{
    ...
    using static ModernBaseLibrary.ExcelWriter.Cell;
    ...
    public class Worksheet
    {
        ...
        /// </summary>
        private ExcelWriter workbookReference;
        ...
        /// </summary>
        private List<Cell.Range> selectedCells;
        ...
        public float DefaultColumnWidth
        {
            ...
            set
            {
                ...
                {
                    throw new ExcelRangeException("OutOfRangeException", "The passed default column width is out of range (" + MIN_COLUMN_WIDTH + " to " + MAX_COLUMN_WIDTH + ")");
                }
        ...
        public float DefaultRowHeight
        {
            ...
            set
            {
                ...
                {
                    throw new ExcelRangeException("OutOfRangeException", "The passed default row height is out of range (" + MIN_ROW_HEIGHT + " to " + MAX_ROW_HEIGHT + ")");
                }
        ...
        public Cell.Range? SelectedCells
        {
            get
            {
        ...
        /// </summary>
        public List<Cell.Range> SelectedCellRanges
        {
        ...
        /// </summary>
        public ExcelWriter WorkbookReference
        {
        ...
        public Worksheet()
        {
            ...
            selectedCells = new List<Cell.Range>();
            activeStyle = null;
        ...
        public Worksheet(string name, int id, ExcelWriter reference)
            : this()
        {
            SetSheetName(name);
            SheetID = id;
        ...
        private Cell CastValue(object value, int column, int row)
        {
            ...
            else
            {
                ...
                {
                    c = new Cell(value, Cell.CellType.DATE, column, row);
                }
                else
                {
        ...
        private void AddCellRangeInternal<T>(IReadOnlyList<T> values, Cell.Address startAddress, Cell.Address endAddress, Style style)
        {
            ...
            {
                throw new ExcelRangeException("OutOfRangeException", "The number of passed values (" + values.Count + ") differs from the number of cells within the range (" + addresses.Count + ")");
            }
        ...
        public Cell GetCell(Cell.Address address)
        {
            ...
            {
                throw new ExcelWorksheetException("The cell with the address " + address.GetAddress() + " does not exist in this worksheet");
            }
        ...
        public string MergeCells(Cell.Address startAddress, Cell.Address endAddress)
        {
            ...
            foreach (KeyValuePair<string, Cell.Range> item in mergedCells)
            {
                ...
                {
                    throw new ExcelRangeException("ConflictingRangeException", "The passed range: " + value.ToString() + " contains cells that are already in the defined merge range: " + item.Key);
                }
            }
        ...
        public void RemoveMergedCells(string range)
        {
            ...
            {
                throw new ExcelRangeException("UnknownRangeException", "The cell range " + range + " was not found in the list of merged cell ranges");
            }
        ...
        public void SetColumnWidth(int columnNumber, float width)
        {
            ...
            {
                throw new ExcelRangeException("OutOfRangeException", "The column width (" + width + ") is out of range. Range is from " + MIN_COLUMN_WIDTH + " to " + MAX_COLUMN_WIDTH + " (chars).");
            }
            if (columns.ContainsKey(columnNumber))
            {
        ...
        public void SetSelectedCells(string range)
        {
            ...
            {
                SetSelectedCells(new Cell.Range(range));
            }
        }
        ...
        public void AddSelectedCells(Cell.Range range)
        {
        ...
        {
            selectedCells.Add(new Cell.Range(startAddress, endAddress));
        }
        ...
        public void SetRowHeight(int rowNumber, float height)
        {
            ...
            {
                throw new ExcelRangeException("OutOfRangeException", "The row height (" + height + ") is out of range. Range is from " + MIN_ROW_HEIGHT + " to " + MAX_ROW_HEIGHT + " (equals 546px).");
            }
            if (rowHeights.ContainsKey(rowNumber))
            {
        ...
        public void SetSplit(int? numberOfColumnsFromLeft, int? numberOfRowsFromTop, bool freeze, Cell.Address topLeftCell, WorksheetPane activePane)
        {
            if (freeze)
            {
                ...
                {
                    throw new ExcelWorksheetException("The column number " + topLeftCell.Column +
                ...
                {
                    throw new ExcelWorksheetException("The row number " + topLeftCell.Row +
        ...
        public Worksheet Copy()
        {
            ...
            {
                foreach (Cell.Range selectedCellRange in this.selectedCells)
                {
        ...
        public static string SanitizeWorksheetName(string input, ExcelWriter workbook)
        {
        ...
        private static string GetUnusedWorksheetName(string name, ExcelWriter workbook)
        {
            if (workbook == null)
            {
                throw new ExcelWorksheetException("The workbook reference is null");
            }
        ...
        private static bool WorksheetExists(string name, ExcelWriter workbook)
        {
            if (workbook == null)
            {
                throw new ExcelWorksheetException("The workbook reference is null");
        ...
        public class Column
        {
            ...
            public string ColumnAddress
            {
                ...
                set
                {
                    ...
                    {
                        throw new ExcelRangeException("A general range exception occurred", "The passed address was null or empty");
                    }
            ...
            public float Width
            {
                ...
                set
                {
                    ...
                    {
                        throw new ExcelRangeException("A general range exception occurred", "The passed column width is out of range (" + Worksheet.MIN_COLUMN_WIDTH + " to " + Worksheet.MAX_COLUMN_WIDTH + ")");
                    }
                    width = value;
                }
            }
