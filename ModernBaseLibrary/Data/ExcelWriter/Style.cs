...
namespace ModernBaseLibrary.ExcelWriter
{
    ...
    public class Style : AbstractStyle
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                throw new ExcelStyleException("MissingReferenceException", "The hash of the style could not be created because one or more components are missing as references");
            }
        ...
        public override AbstractStyle Copy()
        {
            if (CurrentBorder == null || CurrentCellXf == null || CurrentFill == null || CurrentFont == null || CurrentNumberFormat == null)
            {
                throw new ExcelStyleException("MissingReferenceException", "The style could not be copied because one or more components are missing as references");
            }
        ...
        public class CellXf : AbstractStyle
        {
            ...
            public int Indent
            {
                ...
                set
                {
                    ...
                    {
                        throw new ExcelStyleException("A general style exception occurred", "The indent value '" + value + "' is not valid. It must be >= 0");
                    }
                }
            }
        ...
        public class Fill : AbstractStyle
        {
            ...
            /// </summary>
            public static readonly string DEFAULT_COLOR = "00FFFFFF";
            ...
            public static void ValidateColor(string hexCode, bool useAlpha, bool allowEmpty = false)
            {
                if (string.IsNullOrEmpty(hexCode))
                {
                    ...
                    throw new ExcelStyleException("A general style exception occurred", "The color expression was null or empty");
                }
                int length;
                length = useAlpha ? 8 : 6;
                if (hexCode == null || hexCode.Length != length)
                {
                    throw new ExcelStyleException("A general style exception occurred", "The value '" + hexCode + "' is invalid. A valid value must contain six hex characters");
                }
                if (!Regex.IsMatch(hexCode, "[a-fA-F0-9]{6,8}"))
                {
                    throw new ExcelStyleException("A general style exception occurred", "The expression '" + hexCode + "' is not a valid hex value");
                }
            }
        }
        ...
        public class Font : AbstractStyle
        {
            ...
            public int ColorTheme
            {
                ...
                set
                {
                    if (value < 0)
                    {
                        throw new ExcelStyleException("A general style exception occurred", "The color theme number " + value + " is invalid. Should be >0");
                    }
                    colorTheme = value;
                }
            }
            ...
            public string Name
            {
                ...
                set
                {
                    ...
                    {
                        throw new ExcelStyleException("A general style exception occurred", "The font name was null or empty");
                    }
                    name = value;
                }
            }
        ...
        public class NumberFormat : AbstractStyle
        {
            ...
            public int CustomFormatID
            {
                ...
                set
                {
                    ...
                    {
                        throw new ExcelStyleException("A general style exception occurred", "The number '" + value + "' is not a valid custom format ID. Must be at least " + CUSTOMFORMAT_START_NUMBER);
                    }
    ...
    public abstract class AbstractStyle : IComparable<AbstractStyle>
    {
        ...
        internal void CopyProperties<T>(T source, T reference) where T : AbstractStyle
        {
            ...
            {
                throw new ExcelStyleException("CopyPropertyException", "The objects of the source, target and reference for style appending are not of the same type");
            }
