namespace ModernBaseLibrary.ExcelWriter
{
    ...
    internal class LowLevel
    {
        ...
        /// Defines the workbook
        /// </summary>
        private readonly ExcelWriter workbook;
        ...
        public LowLevel(ExcelWriter workbook)
        {
        ...
        private string CreateWorkbookDocument()
        {
            ...
            {
                throw new ExcelRangeException("OutOfRangeException", "The workbook can not be created because no worksheet was defined.");
            }
            StringBuilder sb = new StringBuilder();
