namespace ModernBaseLibrary.ExcelReader
{
    ...
    using ModernBaseLibrary.ExcelReader.Log;
    ...
    public class ExcelBinaryReader : IExcelDataReader
    {
        ...
        public DataSet AsDataSet(bool convertOADateTime)
        {
            ...
            {
                DataTable table = this.readWholeWorkSheet(m_sheets[index]);
        ...
        public System.Data.DataTable AsDataTable(string name)
        {
            ...
            bool nameFound = m_sheets.Any(x => x.Name == name);
            if (nameFound == true)
            {
                result = AsDataSet(true).Tables[name];
            }
