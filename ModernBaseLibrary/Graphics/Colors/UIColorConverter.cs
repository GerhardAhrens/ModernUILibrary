...
namespace ModernBaseLibrary.Graphics
{
    ...
    {
        public static ColorHsla ToHsl(this ColorRgba rgba)
        {
            return RgbToHsl(rgba.Red, rgba.Green, rgba.Blue, rgba.Alpha);
        }

        public static ColorHsla RgbToHsl(byte red, byte green, byte blue, byte alpha = 255)
        {
            ...
            {
                return new ColorHsla(0f, 0f, luminosity);
            }
            ...
            return new ColorHsla(hue * 60f, saturation, luminosity, alpha);
        }

        public static ColorRgba ToRgb(this ColorHsla hsla)
        {
            return HslToRgb(hsla.Hue, hsla.Saturation, hsla.Luminosity, hsla.Alpha);
        }

        public static ColorRgba HslToRgb(float hue, float saturation, float luminosity)
        {
            return HslToRgb(hue, saturation, luminosity, 255);
        }

        public static ColorRgba HslToRgb(float hue, float saturation, float luminosity, byte alpha)
        {
            byte red, green, blue;
