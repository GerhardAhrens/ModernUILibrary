namespace ModernBaseLibrary.Graphics
{
    ...
    {
        public ColorHsla(float hue, float saturation, float luminosity) : this(hue, saturation, luminosity, 255)
        {
        }

        public ColorHsla(float hue, float saturation, float luminosity, byte alpha)
        {
            Hue = hue;
