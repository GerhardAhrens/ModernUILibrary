//-----------------------------------------------------------------------
// <copyright file="MimeTypeInfo.cs" company="Lifeprojects.de">
//     Class: MimeTypeInfo
...
//
// <summary>
// Ermitteln des Mimetype zu einem File
// </summary>
//-----------------------------------------------------------------------
...
namespace ModernBaseLibrary.Graphics
{
    ...
    public static class MimeTypeInfo
    {
        ...
        {
            return MimeTypeInfo.TryGetMimeType(str, out var result) ? result : DefaultMimeType;
        }
