//-----------------------------------------------------------------------
// <copyright file="Code128Encoder.cs" company="Lifeprojects.de">
...
namespace ModernBaseLibrary.Barcode
{
    ...
    internal class Code128Encoder : LinearEncoder
    {
        ...
        private void LoadSymbologyPattern()
        {
            ...
            {                                                                    //   A     |    B    | C
                {0, new LinearPattern("212222", BarcodeModuleType.Bar)},       // SPACE   | SPACE   | 00
                {1, new LinearPattern("222122", BarcodeModuleType.Bar)},       // !       | !       | 01
                {2, new LinearPattern("222221", BarcodeModuleType.Bar)},       // "       | "       | 02
                {3, new LinearPattern("121223", BarcodeModuleType.Bar)},       // #       | #       | 03
                {4, new LinearPattern("121322", BarcodeModuleType.Bar)},       // $       | $       | 04
                {5, new LinearPattern("131222", BarcodeModuleType.Bar)},       // %       | %       | 05
                {6, new LinearPattern("122213", BarcodeModuleType.Bar)},       // &       | &       | 06
                {7, new LinearPattern("122312", BarcodeModuleType.Bar)},       // '       | '       | 07
                {8, new LinearPattern("132212", BarcodeModuleType.Bar)},       // (       | (       | 08
                {9, new LinearPattern("221213", BarcodeModuleType.Bar)},       // )       | )       | 09
                {10, new LinearPattern("221312", BarcodeModuleType.Bar)},      // *       | *       | 10
                {11, new LinearPattern("231212", BarcodeModuleType.Bar)},      // +       | +       | 11
                {12, new LinearPattern("112232", BarcodeModuleType.Bar)},      // ,       | ,       | 12
                {13, new LinearPattern("122132", BarcodeModuleType.Bar)},      // -       | -       | 13
                {14, new LinearPattern("122231", BarcodeModuleType.Bar)},      // .       | .       | 14
                {15, new LinearPattern("113222", BarcodeModuleType.Bar)},      // /       | /       | 15
                {16, new LinearPattern("123122", BarcodeModuleType.Bar)},      // 0       | 0       | 16
                {17, new LinearPattern("123221", BarcodeModuleType.Bar)},      // 1       | 1       | 17
                {18, new LinearPattern("223211", BarcodeModuleType.Bar)},      // 2       | 2       | 18
                {19, new LinearPattern("221132", BarcodeModuleType.Bar)},      // 3       | 3       | 19
                {20, new LinearPattern("221231", BarcodeModuleType.Bar)},      // 4       | 4       | 20
                {21, new LinearPattern("213212", BarcodeModuleType.Bar)},      // 5       | 5       | 21
                {22, new LinearPattern("223112", BarcodeModuleType.Bar)},      // 6       | 6       | 22
                {23, new LinearPattern("312131", BarcodeModuleType.Bar)},      // 7       | 7       | 23
                {24, new LinearPattern("311222", BarcodeModuleType.Bar)},      // 8       | 8       | 24
                {25, new LinearPattern("321122", BarcodeModuleType.Bar)},      // 9       | 9       | 25
                {26, new LinearPattern("321221", BarcodeModuleType.Bar)},      // :       | :       | 26
                {27, new LinearPattern("312212", BarcodeModuleType.Bar)},      // ;       | ;       | 27
                {28, new LinearPattern("322112", BarcodeModuleType.Bar)},      // <       | <       | 28
                {29, new LinearPattern("322211", BarcodeModuleType.Bar)},      // =       | =       | 29
                {30, new LinearPattern("212123", BarcodeModuleType.Bar)},      // >       | >       | 30
                {31, new LinearPattern("212321", BarcodeModuleType.Bar)},      // ?       | ?       | 31
                {32, new LinearPattern("232121", BarcodeModuleType.Bar)},      // @       | @       | 32
                {33, new LinearPattern("111323", BarcodeModuleType.Bar)},      // A       | A       | 33
                {34, new LinearPattern("131123", BarcodeModuleType.Bar)},      // B       | B       | 34
                {35, new LinearPattern("131321", BarcodeModuleType.Bar)},      // C       | C       | 35
                {36, new LinearPattern("112313", BarcodeModuleType.Bar)},      // D       | D       | 36
                {37, new LinearPattern("132113", BarcodeModuleType.Bar)},      // E       | E       | 37
                {38, new LinearPattern("132311", BarcodeModuleType.Bar)},      // F       | F       | 38
                {39, new LinearPattern("211313", BarcodeModuleType.Bar)},      // G       | G       | 39
                {40, new LinearPattern("231113", BarcodeModuleType.Bar)},      // H       | H       | 40
                {41, new LinearPattern("231311", BarcodeModuleType.Bar)},      // I       | I       | 41
                {42, new LinearPattern("112133", BarcodeModuleType.Bar)},      // J       | J       | 42
                {43, new LinearPattern("112331", BarcodeModuleType.Bar)},      // K       | K       | 43
                {44, new LinearPattern("132131", BarcodeModuleType.Bar)},      // L       | L       | 44
                {45, new LinearPattern("113123", BarcodeModuleType.Bar)},      // M       | M       | 45
                {46, new LinearPattern("113321", BarcodeModuleType.Bar)},      // N       | N       | 46
                {47, new LinearPattern("133121", BarcodeModuleType.Bar)},      // O       | O       | 47
                {48, new LinearPattern("313121", BarcodeModuleType.Bar)},      // P       | P       | 48
                {49, new LinearPattern("211331", BarcodeModuleType.Bar)},      // Q       | Q       | 49
                {50, new LinearPattern("231131", BarcodeModuleType.Bar)},      // R       | R       | 50
                {51, new LinearPattern("213113", BarcodeModuleType.Bar)},      // S       | S       | 51
                {52, new LinearPattern("213311", BarcodeModuleType.Bar)},      // T       | T       | 52
                {53, new LinearPattern("213131", BarcodeModuleType.Bar)},      // U       | U       | 53
                {54, new LinearPattern("311123", BarcodeModuleType.Bar)},      // V       | V       | 54
                {55, new LinearPattern("311321", BarcodeModuleType.Bar)},      // W       | W       | 55
                {56, new LinearPattern("331121", BarcodeModuleType.Bar)},      // X       | X       | 56
                {57, new LinearPattern("312113", BarcodeModuleType.Bar)},      // Y       | Y       | 57
                {58, new LinearPattern("312311", BarcodeModuleType.Bar)},      // Z       | Z       | 58
                {59, new LinearPattern("332111", BarcodeModuleType.Bar)},      // [       | [       | 59
                {60, new LinearPattern("314111", BarcodeModuleType.Bar)},      // \       | \       | 60
                {61, new LinearPattern("221411", BarcodeModuleType.Bar)},      // ]       | ]       | 61
                {62, new LinearPattern("431111", BarcodeModuleType.Bar)},      // ^       | ^       | 62
                {63, new LinearPattern("111224", BarcodeModuleType.Bar)},      // _       | _       | 63
                {64, new LinearPattern("111422", BarcodeModuleType.Bar)},      // NUL     | `       | 64
                {65, new LinearPattern("121124", BarcodeModuleType.Bar)},      // SOH     | a       | 65
                {66, new LinearPattern("121421", BarcodeModuleType.Bar)},      // STX     | b       | 66
                {67, new LinearPattern("141122", BarcodeModuleType.Bar)},      // ETX     | c       | 67
                {68, new LinearPattern("141221", BarcodeModuleType.Bar)},      // EOT     | d       | 68
                {69, new LinearPattern("112214", BarcodeModuleType.Bar)},      // ENQ     | e       | 69
                {70, new LinearPattern("112412", BarcodeModuleType.Bar)},      // ACK     | f       | 70
                {71, new LinearPattern("122114", BarcodeModuleType.Bar)},      // BEL     | g       | 71
                {72, new LinearPattern("122411", BarcodeModuleType.Bar)},      // BS      | h       | 72
                {73, new LinearPattern("142112", BarcodeModuleType.Bar)},      // HT      | i       | 73
                {74, new LinearPattern("142211", BarcodeModuleType.Bar)},      // LF      | j       | 74
                {75, new LinearPattern("241211", BarcodeModuleType.Bar)},      // VT      | k       | 75
                {76, new LinearPattern("221114", BarcodeModuleType.Bar)},      // FF      | l       | 76
                {77, new LinearPattern("413111", BarcodeModuleType.Bar)},      // CR      | m       | 77
                {78, new LinearPattern("241112", BarcodeModuleType.Bar)},      // SO      | n       | 78
                {79, new LinearPattern("134111", BarcodeModuleType.Bar)},      // SI      | o       | 79
                {80, new LinearPattern("111242", BarcodeModuleType.Bar)},      // DLE     | p       | 80
                {81, new LinearPattern("121142", BarcodeModuleType.Bar)},      // DC1     | q       | 81
                {82, new LinearPattern("121241", BarcodeModuleType.Bar)},      // DC2     | r       | 82
                {83, new LinearPattern("114212", BarcodeModuleType.Bar)},      // DC3     | s       | 83
                {84, new LinearPattern("124112", BarcodeModuleType.Bar)},      // DC4     | t       | 84
                {85, new LinearPattern("124211", BarcodeModuleType.Bar)},      // NAK     | u       | 85
                {86, new LinearPattern("411212", BarcodeModuleType.Bar)},      // SYN     | v       | 86
                {87, new LinearPattern("421112", BarcodeModuleType.Bar)},      // ETB     | w       | 87
                {88, new LinearPattern("421211", BarcodeModuleType.Bar)},      // CAN     | x       | 88
                {89, new LinearPattern("212141", BarcodeModuleType.Bar)},      // EM      | y       | 89
                {90, new LinearPattern("214121", BarcodeModuleType.Bar)},      // SUB     | z       | 90
                {91, new LinearPattern("412121", BarcodeModuleType.Bar)},      // ESC     | {       | 91
                {92, new LinearPattern("111143", BarcodeModuleType.Bar)},      // FS      | |       | 92
                {93, new LinearPattern("111341", BarcodeModuleType.Bar)},      // GS      | }       | 93
                {94, new LinearPattern("131141", BarcodeModuleType.Bar)},      // RS      | ~       | 94
                {95, new LinearPattern("114113", BarcodeModuleType.Bar)},      // US      | DEL     | 95
                {96, new LinearPattern("114311", BarcodeModuleType.Bar)},      // FNC 3   | FNC 3   | 96
                {97, new LinearPattern("411113", BarcodeModuleType.Bar)},      // FNC 2   | FNC 2   | 97
                {98, new LinearPattern("411311", BarcodeModuleType.Bar)},      // SHIFT B | SHIFT A | 98
                {99, new LinearPattern("113141", BarcodeModuleType.Bar)},      // CODE C  | CODE C  | 99
                {100, new LinearPattern("114131", BarcodeModuleType.Bar)},     // CODE B  | FNC 4   | CODE B
                {101, new LinearPattern("311141", BarcodeModuleType.Bar)},     // FNC 4   | CODE A  | CODE A
                {102, new LinearPattern("411131", BarcodeModuleType.Bar)},     // FNC 1   | FNC 1   | FNC 1
                {103, new LinearPattern("211412", BarcodeModuleType.Bar)},     // START CODE A
                {104, new LinearPattern("211214", BarcodeModuleType.Bar)},     // START CODE B
                {105, new LinearPattern("211232", BarcodeModuleType.Bar)},     // START CODE C
                {106, new LinearPattern("2331112", BarcodeModuleType.Bar)}     // STOP
            };
        }
