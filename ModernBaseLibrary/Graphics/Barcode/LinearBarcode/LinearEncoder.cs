//-----------------------------------------------------------------------
// <copyright file="LinearEncoder.cs" company="Lifeprojects.de">
//     Class: LinearEncoder
...
namespace ModernBaseLibrary.Barcode
{
    ...
    public abstract class LinearEncoder
    {
        ...
        {
            this.EncodedValue = BarcodeValidator.Parse(barcodeValue, Symbology);
            Encode(EncodedValue);
        }
        ...
        {
            this.LinearEncoding.Clear();
            this.Generate(barcodeValue);
        ...
        {
            get => this._humanReadableValue;
            set
            {
                this._humanReadableValue = value;
        ...
        {
            get => this._humanReadableSymbolAligned;
            set
            {
                this._humanReadableSymbolAligned = value;
                this.PropertyChanged = true;
            }
        }
        ...
        public void SetHumanReadableFont(string fontFamily, int pointSize)
        {
            ...
            try
            {
                this.HumanReadableFont = new Font(new FontFamily(fontFamily), pointSize);
            }
            catch (Exception)
            {
                this.HumanReadableFont = SystemFonts.DefaultFont;
            }
        ...
        public void SetEncodingFontFamily(string fontFamily)
        {
            try
            {
                this.EncodingFontFamily = new FontFamily(fontFamily);
            }
            catch (Exception)
            {
                this.EncodingFontFamily = SystemFonts.DefaultFont.FontFamily;
            }
