//-----------------------------------------------------------------------
// <copyright file="Code39Encoder.cs" company="Lifeprojects.de">
//     Class: Code39Encoder
...
namespace ModernBaseLibrary.Barcode
{
    ...
    public class Code39Encoder : LinearEncoder
    {
        ...
        private void LoadSymbologyPattern()
        {
            ...
            {
                {0, new LinearPattern("NWNNWNWNN", BarcodeModuleType.Bar, WideBarRatio)},       // START/STOP
                {1, new LinearPattern("N", BarcodeModuleType.Space, WideBarRatio)},             // SPACER
                {32, new LinearPattern("NWWNNNWNN", BarcodeModuleType.Bar, WideBarRatio)},      // SPACE
                {36, new LinearPattern("NWNWNWNNN", BarcodeModuleType.Bar, WideBarRatio)},      // $
                {37, new LinearPattern("NNNWNWNWN", BarcodeModuleType.Bar, WideBarRatio)},      // %
                {43, new LinearPattern("NWNNNWNWN", BarcodeModuleType.Bar, WideBarRatio)},      // +
                {45, new LinearPattern("NWNNNNWNW", BarcodeModuleType.Bar, WideBarRatio)},      // -
                {46, new LinearPattern("WWNNNNWNN", BarcodeModuleType.Bar, WideBarRatio)},      // .
                {47, new LinearPattern("NWNWNNNWN", BarcodeModuleType.Bar, WideBarRatio)},      // /
                {48, new LinearPattern("NNNWWNWNN", BarcodeModuleType.Bar, WideBarRatio)},      // 0
                {49, new LinearPattern("WNNWNNNNW", BarcodeModuleType.Bar, WideBarRatio)},      // 1
                {50, new LinearPattern("NNWWNNNNW", BarcodeModuleType.Bar, WideBarRatio)},      // 2
                {51, new LinearPattern("WNWWNNNNN", BarcodeModuleType.Bar, WideBarRatio)},      // 3
                {52, new LinearPattern("NNNWWNNNW", BarcodeModuleType.Bar, WideBarRatio)},      // 4
                {53, new LinearPattern("WNNWWNNNN", BarcodeModuleType.Bar, WideBarRatio)},      // 5
                {54, new LinearPattern("NNWWWNNNN", BarcodeModuleType.Bar, WideBarRatio)},      // 6
                {55, new LinearPattern("NNNWNNWNW", BarcodeModuleType.Bar, WideBarRatio)},      // 7
                {56, new LinearPattern("WNNWNNWNN", BarcodeModuleType.Bar, WideBarRatio)},      // 8
                {57, new LinearPattern("NNWWNNWNN", BarcodeModuleType.Bar, WideBarRatio)},      // 9
                {65, new LinearPattern("WNNNNWNNW", BarcodeModuleType.Bar, WideBarRatio)},      // A
                {66, new LinearPattern("NNWNNWNNW", BarcodeModuleType.Bar, WideBarRatio)},      // B
                {67, new LinearPattern("WNWNNWNNN", BarcodeModuleType.Bar, WideBarRatio)},      // C
                {68, new LinearPattern("NNNNWWNNW", BarcodeModuleType.Bar, WideBarRatio)},      // D
                {69, new LinearPattern("WNNNWWNNN", BarcodeModuleType.Bar, WideBarRatio)},      // E
                {70, new LinearPattern("NNWNWWNNN", BarcodeModuleType.Bar, WideBarRatio)},      // F
                {71, new LinearPattern("NNNNNWWNW", BarcodeModuleType.Bar, WideBarRatio)},      // G
                {72, new LinearPattern("WNNNNWWNN", BarcodeModuleType.Bar, WideBarRatio)},      // H
                {73, new LinearPattern("NNWNNWWNN", BarcodeModuleType.Bar, WideBarRatio)},      // I
                {74, new LinearPattern("NNNNWWWNN", BarcodeModuleType.Bar, WideBarRatio)},      // J
                {75, new LinearPattern("WNNNNNNWW", BarcodeModuleType.Bar, WideBarRatio)},      // K
                {76, new LinearPattern("NNWNNNNWW", BarcodeModuleType.Bar, WideBarRatio)},      // L
                {77, new LinearPattern("WNWNNNNWN", BarcodeModuleType.Bar, WideBarRatio)},      // M
                {78, new LinearPattern("NNNNWNNWW", BarcodeModuleType.Bar, WideBarRatio)},      // N
                {79, new LinearPattern("WNNNWNNWN", BarcodeModuleType.Bar, WideBarRatio)},      // O
                {80, new LinearPattern("NNWNWNNWN", BarcodeModuleType.Bar, WideBarRatio)},      // P
                {81, new LinearPattern("NNNNNNWWW", BarcodeModuleType.Bar, WideBarRatio)},      // Q
                {82, new LinearPattern("WNNNNNWWN", BarcodeModuleType.Bar, WideBarRatio)},      // R
                {83, new LinearPattern("NNWNNNWWN", BarcodeModuleType.Bar, WideBarRatio)},      // S
                {84, new LinearPattern("NNNNWNWWN", BarcodeModuleType.Bar, WideBarRatio)},      // T
                {85, new LinearPattern("WWNNNNNNW", BarcodeModuleType.Bar, WideBarRatio)},      // U
                {86, new LinearPattern("NWWNNNNNW", BarcodeModuleType.Bar, WideBarRatio)},      // V
                {87, new LinearPattern("WWWNNNNNN", BarcodeModuleType.Bar, WideBarRatio)},      // W
                {88, new LinearPattern("NWNNWNNNW", BarcodeModuleType.Bar, WideBarRatio)},      // X
                {89, new LinearPattern("WWNNWNNNN", BarcodeModuleType.Bar, WideBarRatio)},      // Y
                {90, new LinearPattern("NWWNWNNNN", BarcodeModuleType.Bar, WideBarRatio)}       // Z
            };
        }
