//-----------------------------------------------------------------------
// <copyright file="Icons.cs" company="Lifeprojects.de">
//     Class: Icons
...
// <date>25.07.2023</date>
//
// <summary>
// Klasse zur Erstellung eines Icons
// </summary>
//-----------------------------------------------------------------------
...
namespace ModernBaseLibrary.Graphics
{
    ...
    public sealed class Icons
    {
        ...
        public static Icon GenerateNotificationIcon(string text, string theme = "", int dpi = 96, bool useSymbolsFont = false)
        {
            ...
            {
                textToRender = textToRender.Substring(0, 2);
            }

            var textToRenderSizeRatio = 1.0f;
            if (textToRender.Length == 1)
            {
                textToRenderSizeRatio = 0.9f;
            }

            if (textToRender.Length == 2)
            {
                textToRenderSizeRatio = 0.5f;
            }
            ...
            if (useSymbolsFont == true)
            {
                fontFamily = "Segoe UI Symbol";
                textToRenderSizeRatio = 1.8f;
                if (dpi > 96)
                {
                    textToRenderSizeRatio = 1.0f;
                }
            ...
            if (_cache.ContainsKey(cacheKey) == true)
            {
