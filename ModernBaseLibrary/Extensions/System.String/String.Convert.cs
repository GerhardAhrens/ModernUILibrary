namespace ModernBaseLibrary.Extension
{
    ...
    public static partial class StringExtension
    {
        ...
        public static string ConvertEncoding(this string input, Encoding targetEncoding)
        {
            return ConvertEncoding(input, targetEncoding, Encoding.Unicode);
        }
        ...
        /// <exception cref="System.ArgumentNullException">targetEncoding is null</exception>
        public static string ConvertEncoding(this string input, Encoding targetEncoding, Encoding sourceEncoding)
        {
            if (input == null)
            {
