namespace UI.SyntaxBox.Tests
{
    ...
    public class AhoCorasickSearch_Tests
    {
        // ...................................................................
        /// <summary>
        /// Implementiert ein sehr einfaches Szenario, das für die Fehlersuche geeignet ist.
        /// </summary>
        [TestMethod()]
        public void FindAll_AXBY()
        {
            ...
            IEnumerable<Substring> findText = matcher.FindAll(" if something then if goto J elsif");

            Assert.IsNotNull(findText);
            Assert.AreEqual(findText.Count(), 0);
        }
        ...
        public void FindAll_NotNull()
        {
            ...
            IEnumerable<Substring> findText = matcher.FindAll(" if something then if goto J elsif ax, by");

            Assert.IsNotNull(findText);
            Assert.IsTrue(findText.Count() > 0);
        }
