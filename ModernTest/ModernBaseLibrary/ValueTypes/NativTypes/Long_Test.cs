/*
 * <copyright file="Long_Test.cs" company="Lifeprojects.de">
 *     Class: Long_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => (long)4;
        private ValueBase GetSampleValue1() => (long)5;
        private ValueBase GetSampleValue2() => (long)5;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Long_Test"/> class.
        /// </summary>
        public Long_Test()
        {
        }
