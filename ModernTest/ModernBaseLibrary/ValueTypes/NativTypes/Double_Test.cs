/*
 * <copyright file="Double_Test.cs" company="Lifeprojects.de">
 *     Class: Double_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => (double)3.141;
        private ValueBase GetSampleValue1() => (double)2.718;
        private ValueBase GetSampleValue2() => (double)2.718;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Double_Test"/> class.
        /// </summary>
        public Double_Test()
        {
        }
