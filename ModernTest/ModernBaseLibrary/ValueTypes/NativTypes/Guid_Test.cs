/*
 * <copyright file="Guid_Test.cs" company="Lifeprojects.de">
 *     Class: Guid_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => new Guid("{9BC8C864-E196-4162-8C60-D0AE98D2B781}");
        private ValueBase GetSampleValue1() => new Guid("{0B6642DF-7E87-46B5-AA67-699941479ACF}");
        private ValueBase GetSampleValue2() => new Guid("{0B6642DF-7E87-46B5-AA67-699941479ACF}");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Guid_Test"/> class.
        /// </summary>
        public Guid_Test()
        {
        }
