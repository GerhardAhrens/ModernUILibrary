/*
 * <copyright file="String_Test.cs" company="Lifeprojects.de">
 *     Class: String_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => "Hallo Welt";

        private ValueBase GetSampleValue1() => "Hallo Gerhard";
        private ValueBase GetSampleValue2() => "Hallo Gerhard";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="String_Test"/> class.
        /// </summary>
        public String_Test()
        {
        }
