/*
 * <copyright file="Float_Test.cs" company="Lifeprojects.de">
 *     Class: Float_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => (float)3.141;
        private ValueBase GetSampleValue1() => (float)2.718;
        private ValueBase GetSampleValue2() => (float)2.718;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Float_Test"/> class.
        /// </summary>
        public Float_Test()
        {
        }
