/*
 * <copyright file="Byte_Test.cs" company="Lifeprojects.de">
 *     Class: Byte_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => (byte)4;
        private ValueBase GetSampleValue1() => (byte)5;
        private ValueBase GetSampleValue2() => (byte)5;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Byte_Test"/> class.
        /// </summary>
        public Byte_Test()
        {
        }
