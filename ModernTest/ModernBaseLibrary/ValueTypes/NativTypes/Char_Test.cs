/*
 * <copyright file="Char_Test.cs" company="Lifeprojects.de">
 *     Class: Char_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => (char)'a';
        private ValueBase GetSampleValue1() => (char)'A';
        private ValueBase GetSampleValue2() => (char)'A';
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Char_Test"/> class.
        /// </summary>
        public Char_Test()
        {
        }
