/*
 * <copyright file="Int_Test.cs" company="Lifeprojects.de">
 *     Class: Int_Test
...
namespace ModernTest.ModernBaseLibrary.ValueTypes
{
    ...
    {
        private ValueBase GetOtherValue() => (int)4;
        private ValueBase GetSampleValue1() => (int)5;
        private ValueBase GetSampleValue2() => (int)5;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Int_Test"/> class.
        /// </summary>
        public Int_Test()
        {
        }
