namespace ModernTest.ModernBaseLibrary.CoreBase
{
    ...
    [TestClass]
    public class ValueObjectBase_A_Test
    {
        [TestMethod]
        ...
        public void ImplementsIEquatable()
        {
            ...
            Assert.IsInstanceOfType(value, typeof(IEquatable<ValueObjectBase>));
        }
        ...
        public void CopyToObject()
        {
            ...
            value2 = value1.CopyTo<TestValue>();
            Assert.AreEqual<TestValue>(value1, value2);
        }

        [TestMethod]
        public void CopyToObjectManyArgs()
        {
            var value1 = new TestValue { Property1 = "string", Property2 = 4 };
            TestValue value2 = null;
            value2 = value1.CopyTo<TestValue>();
        ...
        private class TestValue : ValueObjectBase
        {
            public TestValue() { }
