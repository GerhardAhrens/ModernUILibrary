namespace ModernTest.ModernBaseLibrary.Core
{
    ...
    public class DeepConvertTests
    {
        ...
        public void ChangeType_Nullable()
        {
            ...
            Assert.AreEqual(null, DeepConvert.ChangeType<int?>(string.Empty));
            Assert.AreEqual(null, DeepConvert.ChangeType<bool?>(string.Empty));
            Assert.AreEqual(4, DeepConvert.ChangeType<int?>(4));
        }
        ...
        public void ToDateTime_NoSeparators()
        {
            ...
            Assert.AreEqual(new DateTime(2021, 8, 12, 0, 0, 3), date);
            Assert.AreEqual(DateTimeKind.Unspecified, date.Kind);
        }
