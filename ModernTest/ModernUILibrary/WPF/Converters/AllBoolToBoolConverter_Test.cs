namespace ModernTest.ModernUILibrary.WPF
{
    ...
    [TestClass]
    public class WPF_AllBoolToBoolConverter_Test
    {
        [TestMethod]
        [DataRow(new object[] { false, false }, typeof(bool), null, "de-DE", false)]
        [DataRow(new object[] { true, false }, typeof(bool), null, "de-DE", false)]
        [DataRow(new object[] { true, true }, typeof(bool), null, "de-DE", true)]
        public void AllBoolToBoolConverterWithResult(object[] input, Type targetType, object parameter, string cultureString, object expectedOutput)
        {
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void ProvideValue_returns_instance()
        {
            ...
            Assert.IsTrue(providedValue.GetType() == typeof(AllBoolToBoolConverter));
        }
        ...
        public void Instance_returns_instance()
        {
            ...
            Assert.IsTrue(instance.GetType() == typeof(AllBoolToBoolConverter));
        }
    }
}